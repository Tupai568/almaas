    <div class="login">
        <form class="form" action="/login" method="post">
            @csrf
            <i class="bx bx-x" id="cancel" onclick="cancel()"></i>
            ...
            <div class="inputForm">
                ...
                <input placeholder="Enter your Email" class="input" type="text" name="lgML"
                    value="{{ old('lgML') }}" required>
            ...
            <div class="inputForm">
                ...
                <input placeholder="Enter your Password" class="input" type="password" name="lgPW" required>
            </div>
            ...
            <p class="p">Don't have an account? <a href="/#register"><span class="span">Sign Up</span></a>
